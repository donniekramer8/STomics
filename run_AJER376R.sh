...
prefix="/home/donald/Desktop/Andre_expansion/data/CODA Fallopian tube/visium hd/LK01JHU510_000_analysis/count/AJER376R/outs/binned_outputs/square_016um/donald_analysis/AJER376R_training/"

device="cuda"  # "cuda" or "cpu"
pixel_size=0.5  # desired pixel size for the whole analysis
n_genes=532  # number of most variable genes to impute

# preprocess histology image
echo $pixel_size > "${prefix}pixel-size.txt"
python rescale_WSI_DK.py "${prefix}" --image
